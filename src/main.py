...
from train.lora_train import train as grpo_lora_train
from train.grpo_train import train as grpo_train
from train.sft_train import train as sft_train
...
def main():
    ...
    parser.add_argument(
        ...
        default="train",
        required=True,
        choices=["grpo_lora_train","grpo_train", "sft_train", "inference", "infer_vllm"],
        help="Which task to run.",
    )
    parser.add_argument(
        "--checkpoint_dir",
        type=str,
        default="outputs/Qwen2.5-0.5B-GRPO",
        required=False,
    ...
    if args.task == "grpo_train":
        grpo_train(args)
    if args.task == "grpo_lora_train":
        grpo_lora_train(args)
